      ...
      <div class="content-wrapper">
		...
		<!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="category_insrt.php">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Category Name</label>
                      <input type="text" name="cat_name" class="form-control" required id="exampleInputEmail1" placeholder="Enter Category">
                    </div>
