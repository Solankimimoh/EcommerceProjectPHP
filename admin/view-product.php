...
if(count($products)>0)
{
  ...
  ?>
    <tr>
      <td><img class="img-responsive" src="images/products/medium/<?=str_replace("_P","",$productPhoto)?>"> </td>
      <td ><?php echo $pro['p_name']; ?></td>
      <td ><?php echo $pro['p_price'] ?></td>
     <td ><a class="btn" href="more_detail.php?id=<?php echo $pro['p_id']; ?>">More Detail</a></td>
    </tr>
  ...
  elseif (count($products)<0)
  {
    ?>
      ...
      <script type="text/javascript">
          ...
          alert("There is no product so insert new product");
