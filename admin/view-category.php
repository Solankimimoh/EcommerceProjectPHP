            ...
            <section class="content">
              ...
              <div class="box box-primary">
                ...
                <table style="margin:20px;" class="table table-hover">
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($db->myconn,"SELECT * FROM category");
                    ...
                    while($row=mysqli_fetch_row($query))
                    {
                      ...
                      <tr>
                        ...
                        <td><a href="update-category.php?id=<?php echo $row[0];?> " class="btn btn-success">Update</a></td>
                        <td><a href="delete-category.php?id=<?php echo $row[0];?>" class="btn btn-danger">Delete</a></td>
                      </tr>
                      <?php
                    }
                    ?>
