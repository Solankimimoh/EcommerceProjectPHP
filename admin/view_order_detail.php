              ...
              <div class="box box-primary">
                ...
                <table style="margin:20px;" class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $query = mysqli_query($db->myconn,"SELECT * FROM `user_order_product_detail` WHERE `o_id`='$id'");
                    ...
                    while($row=mysqli_fetch_row($query))
                    {
                      ...
                      <tr>
                        <td>
                          ...
                          <img src="../admin/images/products/medium/<?php echo str_replace('_P','',$productPhoto); ?>" width="100px" height="100px" ></td>
