                                    ...
                                    <tbody>
                                        ...
                                        while($display_data=  mysql_fetch_array($display))
                                        {
                                            ...
                                            echo "<tr class='success'>
                                                    ...
                                                    <td>{$display_data['r_check_out_time']}</td>
                                                    <td>{$user_data['user_name']}</td>
                                                    <td>{$display_data['reservation_status']}</td>
                                                     
                                                    <td><a href='?did={$display_data[0]}'>Remove</a> | <a href='reservation-edit.php?eid={$display_data[0]}'>Update</a>| <a href='finalpayment.php?pid={$display_data[0]}'>Payment</a></td>
