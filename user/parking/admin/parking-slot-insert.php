...
if($_POST)
{
    ...
    $insert=  mysql_query("INSERT INTO `parkingslot` (`slot_name`, `parking_id`) VALUES  ('{$slot_name}','{$parking_id}')") or die(mysql_error());
    if($insert)
    {
                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" name="slot_name" placeholder="Enter Name" class="form-control">
