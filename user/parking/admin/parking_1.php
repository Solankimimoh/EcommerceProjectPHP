...
if($_POST)
{
    ...
    $insert=  mysql_query("INSERT INTO `parking`(`parking_name`, `parking_address`, `parking_latitude`, `parking_longitude`, `parking_pic`, `owner_id`, `location_id`) VALUES "
            . "('{$parking_name}','{$parking_address}','{$parking_latitude}','{$parking_latitude}','{$parking_pic}','{$owner_id}','{$location_id}')") or die(mysql_error());
    if($insert)
    {
