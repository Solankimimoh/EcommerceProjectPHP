...
if($_POST)
{
    ...
    $insert=  mysql_query("INSERT INTO `reservation`(`reservation_date`, `parking_id`, `slot_id`, `reservation_charges`, `r_in_time`, `r_out_time`, `user_id`, `reservation_status`) VALUES "
            . "('{$reservation_date}','{$parking_id}','{$slot_id}','{$reservation_charges}','{$r_in_time}','{$r_out_time}','{$user_id}','{$reservation_status}')") or die(mysql_error());
    if($insert)
    {
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Status</label>
                                            <input class="form-control" type="text" name="reservation_status" placeholder="Enter reservation_status">
                                        </div>
