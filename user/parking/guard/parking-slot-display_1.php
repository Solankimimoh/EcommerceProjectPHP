                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            $delete=$_GET['did'];
                                            $del=  mysql_query("delete from parkingslot where slot_id='{$delete}'");
                                            if($del)
                                            {
                                        ...
                                        $display=mysql_query("SELECT * FROM `parkingslot`") or die(mysql_error());
                                        while($display_data=  mysql_fetch_array($display))
                                        {
                                            ...
                                            echo "<tr class='success'>
                                                    <td>{$display_data['slot_id']}</td>
                                                    <td>{$display_data['slot_name']}</td>
                                                    <td>{$parking_data['parking_name']}</td>
                                                     
                                                    <td><a href='?did={$display_data[0]}'>Remove</a> | <a href='parking-slot-edit.php?eid=$display_data[0]'>Update</a></td>
